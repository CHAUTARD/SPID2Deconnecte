...
namespace SPID2Deconnecte
{
    internal class FromTxt
    {
        ...
        public Tableau TableauFromTxt(string line)
        {
            ...
            pos += 10;
            tableau.TAB_DT_CREATION = SingletonOutils.DateParse(line.Substring(pos, 10));
